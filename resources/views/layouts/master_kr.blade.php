            ...
            <div class="container-fluid home_content-block1" style="padding-left: 0px;padding-right: 0px;">
                <div class="{{ $data->cls_header; }}" id="printout">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            ...
                                            <p class="dropdown_element"><a href="{{url('/service/page/Web-Development')}}">웹 개발</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Mobile-App-Development')}}">모바일 앱 개발</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Custom-Software-Development')}}">커스텀 소프트웨어 개발</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Software-Product-Development')}}">소프트웨어 제품 개발</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Enterprise-Application-Integration')}}">엔터프라이즈 애플리케이션 통합</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Technology-Consulting')}}">테크놀로지 컨설팅</a></p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            ...
                                            <p class="dropdown_element"><a href="{{url('/solution/page/AI-Integration')}}">AI 통합</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/Web-Crawler')}}">크라블라 웹 크롤러</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/HR-Solution')}}">HR 솔루션</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/Trivia-Mobile-Apps')}}">트리비아 모바일 앱</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/ECommerce-and-Web-Solution')}}">E-커머스 및 웹 솔루션</a></p>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <p class="dropdown_element"><a href="{{url('/technology/page/Mobile-Technology')}}">모바일 테크놀로지</a></p>
                                            <p class="dropdown_element"><a href="{{url('/technology/page/Web-Development')}}">웹 개발</a></p>
                                            <p class="dropdown_element"><a href="{{url('/technology/page/Streaming')}}">스트리밍</a></p>
                                            <p class="dropdown_element"><a href="{{url('/technology/page/Artificial-Intelligence')}}">인공 지능</a></p>
                                        </div>
                                    </li>
                    ...
                    <!-- BLUE HEADER SECTION START -->
                        ...
                        @else
                        <!-- CHECK IF NEED TO RENDER TITLE IMAGE -->  
