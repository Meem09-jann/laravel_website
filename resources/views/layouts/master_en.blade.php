                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <a href="{{url('/service')}}">Service</a>
                                        <div class="dropdown-content">
                                            <p class="dropdown_element"><a href="{{url('/solution/page/managr')}}">managR (SaaS)</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Web-Development')}}">Web Development</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Mobile-App-Development')}}">Mobile App Development</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Custom-Software-Development')}}">Custom Software Development</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Software-Product-Development')}}">Software Product Development</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Enterprise-Application-Integration')}}">Enterprise Application Integration</a></p>
                                            <p class="dropdown_element"><a href="{{url('/service/page/Technology-Consulting')}}">Technology Consulting</a></p>
                                        </div>
                                    </li>
                                    ...
                                    <a href="{{url('/solution')}}">Solution</a>
                                        <div class="dropdown-content">
                                            ...
                                            <p class="dropdown_element"><a href="{{url('/solution/page/AI-Integration')}}">AI Integration</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/Web-Crawler')}}">Kravla Web Crawler</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/HR-Solution')}}">HR Solution</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/Trivia-Mobile-Apps')}}">Trivia Mobile Game</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/ECommerce-and-Web-Solution')}}">ECommerce & Web Solution</a></p>
                                    ...
                                    <a href="{{url('/technology')}}">Technology</a>
                                        <div class="dropdown-content">
                                        <p class="dropdown_element"><a href="{{url('/technology/page/Mobile-Technology')}}">Mobile Technology</a></p>
                                            <p class="dropdown_element"><a href="{{url('/technology/page/Web-Development')}}">Web Development</a></p>
                                            <p class="dropdown_element"><a href="{{url('/technology/page/Streaming')}}">Streaming</a></p>
                                            <p class="dropdown_element"><a href="{{url('/technology/page/Artificial-Intelligence')}}">Artificial Intelligence</a></p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="dropdown">
                                        <a href="#">Case Study</a>
                                        <div class="dropdown-content">
                                            <p class="dropdown_element"><a href="{{url('/solution/page/Case-Study-of-RabbiteholeBD')}}">RabbitholeBD</a></p>
                                            <p class="dropdown_element"><a href="{{url('/solution/page/Case-Study-of-CHVOD')}}">CHVOD</a></p>
                                        </div>
                                    </li>
