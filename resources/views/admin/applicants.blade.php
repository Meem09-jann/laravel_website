...
<style type="text/css">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td > <div class="btn btn-success" style="background-color: #62cb62;border-color: #5ec75e;"> <a href="{{url('/admin/applicant/viewCV/'.$cv->id)}}"  class="text-white"><i class="fa fa-eye" ></i></a></div></td>
                <td > <div class="btn btn-danger" style="background-color: #ff2222e8;border-color: #ff2222e8;"> <a href="{{url('/admin/applicant/dltCV/'.$cv->id )}}"  class="text-white"><i class="fa fa-trash" aria-hidden="true"></i></a></div></td>
            </tr>
            @endforeach
 		</tbody>
    </table>
