        ...
        <div class="container">
            ...
            <div class="row">
                <div class="technology-d-text">
                    ...
                    <p>PHP 개발 서비스를 PixelCrayons에 아웃소싱하고 차세대 PHP 웹 애플리케이션을 위한 최신 기술 솔루션을 얻으십시오.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                    <div class="our_services_innr">
                        ...
                        <p class="web-dev-frame"> 우리의 해외 PHP 웹 개발 자회사는 귀사의 특정 요구에 맞는 PHP 웹사이트를 발전시키기 위해 모든 최신 및 최고의 PHP 프레임워크를 개발합니다. </p>
                        <span></span> </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12  wow">
                    <div class="f-development_services_inner animatable fadeInUp"> <small class="Dservices_icon1"></small>
                        ...
                        <p class="web-dev-frame"> 우리의 PHP 개발자 팀은 다양한 비즈니스 분야의 고객을 위해 확장 가능한 CodeIgniter 솔루션을 개발합니다.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12  wow">
                    <div class="f-development_services_inner animatable fadeInUp"> <small class="Dservices_icon3"></small>
                        ...
                        <p class="web-dev-frame"> 우리는 성장하는 기업과 스타트업을 위해 강력하고 비용 효율적인 Yii 개발 솔루션을 제공합니다.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 wow">
                    ...
                    <div class="f-development_services_inner animatable fadeInUp"> <small class="Dservices_icon4"></small>
                        <h4 class="web-deb-frame-name"> Laravel 개발 </h4>
                        <p class="web-dev-frame"> 우리의 PHP 프로그래머 팀은 귀사의 비즈니스 기업을 위한 엔드 투 엔드 맞춤형 Laravel 개발 솔루션을 제공합니다. </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 wow">
                    <div class="f-development_services_inner animatable fadeInUp"> <small class="Dservices_icon2"></small>
                        ...
                        <p class="web-dev-frame"> 우리는 또한 Zend, CakePHP, Symfony, Phalcon을 포함한 다른 프레임워크에 대한 노드 Js 개발 및 PHP 개발을 제공합니다. </p>
                    </div>
                </div>
