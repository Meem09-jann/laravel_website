...
@section('content')
    ...
    <section id="gallery">
        <div class="container">
            <div id="image-gallery">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img src="{{ asset('assets/img/technology.png') }}" alt="loading" class="img-responsive t-detail-img">
                    </div>
                </div>
            ...
            <div class="row" style="clear: both;">
                ...
                <div class="col-md-12">
                    <div class="tabs" style="padding-top: 0px;margin-bottom: 0px;">
                        ...
                        <div class="tabs__bar">
                            <div class="tabs__controls md-ripple">Mobile Technology </div>
                            <div class="tabs__controls md-ripple">Web Development</div>
                            <div class="tabs__controls md-ripple">Streaming</div>
                                            ...
                                            <a href="{{url('/technology/mobile-technology')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l ">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Middleware</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/mobile-technology')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l ">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Application Platform</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/mobile-technology')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Backend</span>
                                                    </div>  
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/mobile-technology')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Frameworks, components</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/web-development')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l ">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Front-End</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/web-development')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l ">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Back-End</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/web-development')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Database</span>
                                                    </div>  
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/streaming')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">ENGINE</span>
                                                    </div>  
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/streaming')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Player</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/artificial-intelligence')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l" style="text-align: center;">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Machine Learning</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/artificial-intelligence')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l ">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Natural Language Proccessing</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                            ...
                                            <a href="{{url('/technology/artificial-intelligence')}}" class="tech-links">
                                                <div class="_3iWHUCfYpJAiSspC18r09l">
                                                    <div class="_39v3lYF5ESPfWrarECyBj-">
                                                        ...
                                                        <span class="_2DsR8g8lShsK9x5IbpaSYf">Speech Recognition</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
            ...
            <div class="row mglr">
               <!-- <div class="col-sm-8 crawl-feature-left">
                ...
                <div class="col-sm-12 crawl-feature-left">
                    <img src="{{ asset('assets/img/development_methodologies.png') }}" alt="" class="crawl-feature-left-img">
                </div>
            </div>
            ...
            <div class="row mglr">
                <div class="col-sm-offset-2 col-sm-8" style="text-align: center;margin-bottom: 2%;">
                    <h3 class="product-tech-heading" style="padding-top: 2%;">
                        mDO - Managed Development Oversight
                    </h3>
                ...
                <div class="col-sm-12" style="margin-bottom: 25px;">
                    <img src="{{ asset('assets/img/mDO_Managed_Development_Oversight.png') }}" alt="" class="crawl-feature-left-img">
                </div>
    ...
    <div class="container" style="margin-bottom: 5%">
        <div class="row mglr">
            ...
            <div class="row mglr">
                <div class="col-sm-8 crawl-feature-left">
                    <img src="{{ asset('assets/img/test-tools.png') }}" alt="" class="crawl-feature-left-img">
                </div>
                <div class="col-sm-4 crawl-feature-right">
                   <!-- <h3 class="method-heading">Software Testing Tools</h3> -->
                   <p class="method-pera">Application testing tools make enterprises' app development more efficient. The tools we stated here are included but not limited to serve our testing cases. Testing tools can be selected depending on application variety as well as client's preference.</p> 
                </div>
            </div>
        </div>
    </div>
