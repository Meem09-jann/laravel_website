        ...
        <div class="container case_study_con">
            <div class="row main_rows">
                ...
                <div class="col-sm-8 case-cols">
                    <p class="casestudyinfo">당사의 제품 군중 하나인 스트리밍 솔루션 “BlessBit”를 활용한 “HDTELCOM”사의 서비스 사례이며, 우수한 기능과 확장성, 유연성이 뛰어난 SaaS 플랫폼을 활용하여 비즈니스의 확신을 높이는 서비스는 info@ticonsys.com으로 문의해 주십시오.</p>
                </div>
            ...
            <div class="row main_rows">
                <div class="col-sm-4 case-cols">
                    ...
                    <h3 class="casestudy_title"><strong>CHVOD</strong> :</h3>
                </div>

                <div class="col-sm-8 case-cols">
                    <p class="casestudyinfo">20XX부터 “CHVOD”는 처음부터 프리미엄 미디어 콘텐츠를 유료 서비스로 제공하는 사업을 시작했으며, 이미 충성도가 높은 고객에게 프리미엄 유료 콘텐츠를 확대하는 비즈니스 모델을 추진하면서 별도의 솔루션으로 진행하였으나 수년 동안 운영 후에는 기술적인 문제로 충성도 있는 유료 가입자 확보에 어려움이 발생되었으며, 당사의 “BlessBit”를 도입하여 문제를 해결하여, “HDTELCOM”은 지속적인 유료 가입자의 확보와 고객에게 고품질의 서비스를 제공하는 경험을 하고 있습니다.</p>
                </div>
            </div>
            <hr/>
            ...
            <div class="row main_rows">
                ...
                <div class="col-sm-8 case-cols">
                    <p class="casestudyinfo">”BlessBit”의 도입 전에 “CHVOD”의 문제는 아래와 같습니다.</p>

                    <div class="row">
                        <div class="col-sm-4 case_inner_col">
                            <p class="casestudyinfo">VOD 콘텐츠 제공 : 미디어 콘텐츠 제공 인프라는 한 국가에 유료 가입자는 전 세계에 있어, 미디어 콘텐츠 전달이 엄청나게 지연</p>
                        </div>
                        <div class="col-sm-4 case_inner_col">
                            <p class="casestudyinfo">시스템의 확장 불가 : 고정된 가입자에게만 서비스 제공</p>
                        </div>
                        <div class="col-sm-4 case_inner_col">
                            <p class="casestudyinfo">고정된 하드웨어 배포 : 새로운 시장(국가)에 진출 불가</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4 case_inner_col">
                        ...
                        <div class="col-sm-4 case_inner_col">
                            <p class="casestudyinfo">미디어 콘텐츠에 적용할 수 있는 보안 설정 없음</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row main_rows">
                <div class="col-sm-4 case-cols">
                    ...
                    <h3 class="casestudy_title"><strong>”CHVOD”</strong>가 <strong>“BlessBit”</strong>를 선택한 이유</h3>
                </div>
            ...
            <div class="row main_rows">
                ...
                <div class="col-sm-8 case-cols">
                    <p class="casestudyinfo">“CHVOD”에서 사용되고 있는 아키텍처이며, 이 방법으로 운영 효율과 경제성을 달성</p>
            ...
            <div class="row main_rows">
                <div class="col-sm-4 case-cols">
                    ...
                    <h3 class="casestudy_title"><strong>”CHVOD”</strong>의 결과</h3>
                </div>

                <div class="col-sm-8 case-cols">
                    <p class="casestudyinfo">CHVOD의 결과는 다음과 같습니다:</p>
                    ...
                    <div class="row">
                        <div class="col-sm-4 case_inner_col">
                            <p class="casestudyinfo">백업으로 AWS Snapshot 및 AMI는 필요에 따라 새 웹 서버를 자동으로 제거하고 또는 배포하는 것이 “CHVOD”의 주요 비용 절감 지점이며, 리소스 낭비도 방지</p>
                        </div>
                        <div class="col-sm-4 case_inner_col">
                            <p class="casestudyinfo">AWS S3 및 CloudFront 기반 VOD 콘텐츠 전송은 “CHVOD” 시청자에게 확실한 체험을 보장</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row main_rows">
                ...
                <div class="col-sm-8 case-cols">
                    <p class="casestudyinfo">“BlessBit”을 도입한 “HDTELECOM”은 수익, 성장, 비즈니스 확장 및 유료 사용자의 만족도를 크게 향상하여 장기적인 서비스를 가능하게 했음
                    <br><br>
                    “BlessBit”을 통해 “CHVOD”는 비용 및 테크니컬 오버헤드를 최소화하며, 최고 수준의 서비스 제공 소프트웨어 및 웹 사이트에 대한 우수한 고객 지원과 결합하여 “CHVOD”의 서비스가 큰 성공을 거두는 데 일조 <br> <br> 티콘시스템은 “HDTELECOM”과 지속적인 협력으로 고객의 성공을 함께할 기대하고 있습니다.</p>
                </div>
