...
@push('css')
    <style type="text/css">
        ...
        .blog-filter-container-preview >div{
            /* background-color: #1fb0e593; */
            /* display: flex;
            flex-direction: column; */
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="innertextleft">
                        ...
                        <div class="add" style="text-align: end;margin-block: auto;">
            ...
            <div class="row-main">   
                ...
                <div class="blog-filter-container">
                    ...
                    <div class="blog-filter-container-preview"> 
                        ...
                        <div class="blog-post-date-and-writer" >
                            <!-- WRITER INFORMATION -->
                    ...
                    <ul class="blog-filter">         
                        ...
                        <li class="blog-filter-cat" data-filter="blog-filter-cat"><a href="{{ url('/blog')}}">All</a>
                            <div class="count" style=" ">
                                <h6> @php  echo $totalApprovedBlogs;  @endphp </h6>  
                            </div>
                        </li>
