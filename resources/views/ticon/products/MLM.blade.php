    ...
    <div class="container-div home-block-3">
        <div class="row mglr ">
            <div class="col-sm-6" style="margin-bottom: 10px;">
                ...
                <img src="{{ asset('assets/img/products/MLM_BIG.png') }}" alt="" class="service-details-img">
            </div>
            <div class="col-sm-6 s-content-part">
                <p class="vertical-praimary-heading">MLM Management System</p>

                <p class="vertical-secondary-heading animatable fadeInUp ">Client Name:</p>

                <p class="vertical-secondary-text animatable fadeInUp ">HD telecom Ltd.</p>

                <p class="vertical-secondary-heading animatable fadeInUp ">Platform:</p>
                <p class="vertical-secondary-text animatable fadeInUp ">Web & Android</p>
                ...
                <ul style="list-style-type:circle;" class="animatable fadeInUp " >
                    <li><span>&rarr;</span>Package management</li>
                    <li><span>&rarr;</span>User Management</li>
                    <li><span>&rarr;</span>App Management</li>
                    <li><span>&rarr;</span>Earning History</li>
                    <li><span>&rarr;</span>Withdrawals</li>
