    ...
    <div class="container-div home-block-3">
        <div class="row mglr ">
            <div class="col-sm-6" style="margin-bottom: 10px;">
                ...
                <img src="{{ asset('assets/img/products/CloudAccountica_BIG.png') }}" alt="" class="service-details-img">
            </div>
            <div class="col-sm-6 s-content-part">
                <p class="vertical-praimary-heading">CLOUDACCOUNTICA</p>
                ...
                <p class="vertical-secondary-text animatable fadeInUp ">(All technology stack)- Django, HTML, CSS, javascript, MySQL</p>    
                ...
                <ul style="list-style-type:circle;" class="animatable fadeInUp " >
                    <li><span>&rarr;</span>Admin can upload excel file of all user's payment info </li>
                    <li><span>&rarr;</span>Can create a new user</li>
                    <li><span>&rarr;</span>User can check their payment history, payment amount and the due date</li>
