    ...
    <div class="container-div home-block-3">
        <div class="row mglr ">
            <div class="col-sm-6" style="margin-bottom: 10px;">
                ...
                <img src="{{ asset('assets/img/products/Intra_ERP_BIG.png') }}" alt="" class="service-details-img">
            </div>
            <div class="col-sm-6 s-content-part">
                <p class="vertical-praimary-heading">Intra ERP</p>

                <p class="vertical-secondary-heading animatable fadeInUp ">Client Name:</p>

                <p class="vertical-secondary-text animatable fadeInUp ">Intra Foods BD Ltd.</p>
                ...
                <p class="vertical-secondary-text animatable fadeInUp ">CodeIgniter, PHP, MySQL, Javascript, Bootstrap, Jquery</p>    
                ...
                <ul style="list-style-type:circle;" class="animatable fadeInUp " >
                    ...
                    <li><span>&rarr;</span>Supply Chain Management</li>
                    <li><span>&rarr;</span>Procurement & Purchase</li>
                    <li><span>&rarr;</span>Access Layer Control</li>
                    <li><span>&rarr;</span>Invoicing</li>
                    <li><span>&rarr;</span>Delivery</li>
                    <li><span>&rarr;</span>Reports</li>
