    ...
    <div class="container-div home-block-3">
        <div class="row mglr ">
            <div class="col-sm-6" style="margin-bottom: 10px;">
                ...
                <img src="{{ asset('assets/img/products/Restaurant_Reservation_BIG.png') }}" alt="" class="service-details-img">
            </div>
            <div class="col-sm-6 s-content-part">
                <p class="vertical-praimary-heading">Restaurant Reservation-V</p>
                ...
                <ul style="list-style-type:circle;" class="animatable fadeInUp " >
                    <li><span>&rarr;</span>Phone Number verification</li>
                    <li><span>&rarr;</span>QR code generate using passengers information</li>
