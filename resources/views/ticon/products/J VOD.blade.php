    ...
    <div class="container-div home-block-3">
        <div class="row mglr ">
            <div class="col-sm-6" style="margin-bottom: 10px;">
                ...
                <img src="{{ asset('assets/img/products/0f3a82d5-3393-4f4a-93e7-ed0dfe51ef93-500x500.jpg') }}" alt="" class="service-details-img">
            </div>
            <div class="col-sm-6 s-content-part">
                <p class="vertical-praimary-heading">J VOD</p>
                ...
                <ul style="list-style-type:circle;" class="animatable fadeInUp " >
                    ...
                    <li><span>&rarr;</span>Japanese TV’s Recorded Contents as VOD</li>
